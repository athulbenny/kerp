  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            FutureBuilder<dynamic>(
                ...
                builder: (context, snapshot) {
                  ...
                  //border: Border.all(color: Colors.black)
                                  ...
                                  child: Visited(loc: locatevisit, lat: latvisit, long: longvisit,isv:isv,tdate: tdate,tid:tid,pid:pid)),
                          ],
                        ),
                      );
                    }
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.find_in_page),label: 'Upcoming Tasks'),
...
class Visited extends StatefulWidget {
  const Visited({required this.loc,required this.lat,required this.long,required this.isv,required this.tdate,required this.tid,required this.pid});
  final List<double> lat,long;final List<String> loc,tdate;final int isv;final List<int> tid;
  final String pid;
  @override
  State<Visited> createState() => _VisitedState(loc,lat,long,isv,tdate,tid,pid);
}

class _VisitedState extends State<Visited> {
  List<double> lat,long;List<String> loc,tdate;int isv;List<int> tid;String pid;
  _VisitedState(this.loc,this.lat,this.long,this.isv,this.tdate,this.tid,this.pid);
