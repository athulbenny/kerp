  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                              ...
                              children: [
                                ...
                                Container(decoration: BoxDecoration(
                                  ...
                                  child: Row( children: [
                                    ...
                                    const [Text('location', style: TextStyle(fontSize: 20.0,color: Colors.white))])),
                                    const Expanded(flex:1,child: SizedBox(width:5)),
                                    Expanded(flex:2,child: Column(children:
                                    const [Text('latitude', style: TextStyle(color:Colors.green,fontSize: 20.0))])),
                                    const Expanded(flex:1,child: SizedBox(width: 5,)),
                                    Expanded(flex:2,child: Column(children:
                                    const [Text('longitud', style: TextStyle(color:Colors.green,fontSize: 20.0))])),
                                    const Expanded(flex:1,child: SizedBox(width: 5,)),
                                    Expanded(flex:2,child: Column(children:
                                    const [Text('Date', style: TextStyle(fontSize: 20.0,color: Colors.white))])),
                                  ]),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.find_in_page),label: 'Completed Tasks'),
